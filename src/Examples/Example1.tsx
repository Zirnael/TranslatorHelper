...
export const Example1 = () => {
  const wrapWordsInSpans = (text) => {
    return text.split(/ /).map((word, index) => <Word word={word} />);
  };

  return (
    <div>
      <h1>Title: The Lost Map of Everwood</h1>
      <p>
        {wrapWordsInSpans(`In the quiet town of Everwood, where the streets twisted like the
        branches of ancient trees and every house seemed to harbor a story, a
        summer of unexpected adventure was about to begin.`)}
        <br />
        <br />
        {wrapWordsInSpans(`Four best friends—Ella, Jake, Mia, and Leo—were getting ready for their
        ...
        <br />
        <br />
        {wrapWordsInSpans(`The adventure began one sunny afternoon when Jake, who was known for his
        ...
        <br />
        <br />
        {wrapWordsInSpans(`Excitedly, Jake showed the map to his friends. “Guys, this might be a
        ...
        <br />
        <br />
        {wrapWordsInSpans(`The next day, with backpacks full of snacks, water, and a flashlight,
        ...
        <br />
        <br />
        {wrapWordsInSpans(`As they walked, they shared stories, jokes, and laughed under the canopy
        ...
        <br />
        <br />
        {wrapWordsInSpans(`With bated breath, they searched around the stone, hoping to find a
        ...
        <br />
        <br />
        {wrapWordsInSpans(`Hands trembling with excitement, they opened the chest. Inside, instead
        ...
        <br />
        <br />
        {wrapWordsInSpans(`The letters and photographs told stories of friendship, bravery, and the
        ...
        <br />
        <br />
        {wrapWordsInSpans(`The friends were deeply moved. They realized that the true treasure
        ...
        <br />
        <br />
        {wrapWordsInSpans(`As they made their way back to town, they talked about how this
        ...
        <br />
        <br />
        {wrapWordsInSpans(`The summer ended, and high school began, bringing new challenges and
        ...
        <br />
        <br />
        {wrapWordsInSpans(`Years later, when they looked back on that summer, they realized that
        ...
        <br />
        <br />
        {wrapWordsInSpans(`And so, the story of the Lost Map of Everwood became a cherished part of
